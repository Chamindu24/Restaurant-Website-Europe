...
const Menus = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const menuSectionTop =
        document.querySelector(".menus-section")?.offsetTop || 0;
      const menuSectionHeight =
        document.querySelector(".menus-section")?.offsetHeight || 0;
      const scrollPos = window.scrollY;

      // Show voucher when scrolling in the menus section
      if (
        scrollPos > menuSectionTop + 300 &&
        scrollPos < menuSectionTop + menuSectionHeight - 300
      ) {
        setShowVoucher(true);
        setIsVisible(true);
      } else {
  ...
  `}
    ...
    "
      ...
      {/* Main Menus Section */}
      <section
        className="relative z-10 min-h-screen py-24 px-6 sm:px-12 md:px-12 lg:px-0 bg-repeat menus-section overflow-x-hidden"
        style={{
        ...
        <div className="relative z-10 container mx-auto  max-w-[90rem]">
          ...
          <div className="text-center mb-24">
            ...
            <div className="max-w-4xl mx-auto relative px-4 sm:px-0">
              ...
              <span className="hidden sm:block absolute -top-4 -left-8 text-6xl text-stone-100 font-serif">
                "
              </span>
              <p className="text-stone-500 font-semibold font-serif italic text-2xl leading-relaxed">
                A menu of fresh, seasonal dishes made with quality ingredients
                from across the United Kingdom.
              </p>
              <span className="hidden sm:block absolute -bottom-8 -right-8 text-6xl text-stone-100 font-serif">
                ”
              </span>
            </div>
          </div>
