...
const BookTable = () => {
  ...
  useEffect(() => {
    if (isDrawerOpen) {
      ...
      const selectedDate =
        selectedDateForBooking || new Date().toISOString().split("T")[0];
  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF]  text-[#1a1a1a]">
      ...
      <div className="relative h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[75vh] flex items-center justify-center overflow-hidden bg-[#F9F8F6]">
        {/* Hero Image */}
        <img 
          src="/tablecover.jpg" 
        ...
        <div className="absolute inset-0 bg-[#F9F8F6]/45 backdrop-blur-[0.5px]"></div>
        ...
        <div className="relative z-10 max-w-6xl w-full mx-4 p-8 md:p-16 bg-white/80 backdrop-blur-xs border border-white/50 shadow-[0_20px_50px_rgba(0,0,0,0.05)]">
          ...
          <header className=" relative max-w-[1300px] mx-auto px-4 md:px-6">
            ...
            <div className="text-center px-0 md:px-2 mt-2 md:mt-2">
              <p className="text-stone-600 font-semibold tracking-wide font-serif italic text-base sm:text-lg md:text-2xl leading-relaxed max-w-4xl mx-auto">
                "View our table arrangement below and select your desired
                vantage point. Our interactive map allows you to curate your
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-4 gap-12">
        ...
        <div className="lg:col-span-3">
          <h2 className="text-md uppercase font-medium tracking-widest text-gray-800 mb-8 border-b pb-4">
            01. Select Your Booking Date
          </h2>
          ...
          <div className="mb-10 max-w-3xl p-6 bg-gradient-to-br from-[#1a1a1a] via-[#2a2a2a] to-[#1a1a1a] border border-[#D4AF37]  relative overflow-hidden rounded-sm">
            ...
            <div className="flex items-center justify-between mb-6 pb-4 border-b border-[#D4AF37]/30">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-white uppercase tracking-[0.25em]">
                  {calendarYear}
                </p>
              </div>
            ...
            <div className="grid grid-cols-7 gap-2">
              ...
              {[...Array(getFirstDayOfMonth(calendarMonth, calendarYear))].map(
                (_, i) => (
              ...
              {[...Array(getDaysInMonth(calendarMonth, calendarYear))].map(
                (_, i) => {
                  ...
                  return (
                    ...
                    >
                      <span
                        className={`relative z-10 ${isSelected ? "font-black" : ""}`}
                      >
                        {day}
                      </span>
              ...
              <div className="mt-6 pt-4 border-t border-[#D4AF37]/30">
                <div className="flex items-center justify-between text-sm">
                  <div className="flex-1">
                    <p className="text-[14px] font-semibold uppercase tracking-wider text-[#D4AF37] mb-0.5">
                      Selected
                    </p>
                    <p className="text-lg font-semibold font-serif italic text-white leading-tight">
                      {new Date(selectedDateForBooking).toLocaleDateString(
                        "en-GB",
                        {
                          day: "numeric",
                          month: "short",
                  ...
                  <div className="text-right bg-[#D4AF37]/10 border border-[#D4AF37]/30 px-3 py-2 rounded">
                    {bookedSeats.length > 0 ? (
                      <div>
                        <p className="text-[12px] uppercase tracking-wider text-red-400 font-bold">
                          ⚠ {bookedSeats.length} Booked
                        </p>
                        <p className="text-md font-semibold text-white mt-0.5">
                          {9 * 6 - bookedSeats.length} Available
                        </p>
                      </div>
                    ) : (
                      <div>
                        <p className="text-[12px] uppercase tracking-wider text-green-400 font-bold">
                          ✓ Available
                        </p>
                        <p className="text-md font-semibold text-white mt-0.5">
                          All Seats Open
          ...
          <h2 className="text-md uppercase font-medium tracking-widest text-gray-800 mb-8 border-b pb-4">
            02. Select Your Table & Seats
          </h2>

          <div className="text-center mb-8 md:mb-16">
            <p className="text-[11px] font-black uppercase tracking-[0.3em] text-[#bc9437] mb-2">
              Step 01
            </p>
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-6 mb-12 md:mb-24">
            {tableIDs.map((id) => (
              ...
              >
                ...
                />
                <span
                  className={`relative z-10 text-xl md:text-2xl font-serif font-black transition-colors duration-500
          ...
          <div className="relative w-[320px] h-[320px] md:w-[600px] md:h-[600px] mx-auto flex items-center justify-center">
            ...
            <div className="absolute w-32 h-32 md:w-72 md:h-72 rounded-full bg-[#1a1a1a] border-[4px] border-[#bc9437] shadow-[0_30px_70px_rgba(0,0,0,0.1)] flex flex-col items-center justify-center z-10">
              <div className="text-center">
                <p className="text-[9px] md:text-[12px] font-black uppercase tracking-[0.3em] text-[#bc9437] mb-1">
                  Table
                </p>
                <p className="font-serif font-black text-4xl md:text-7xl text-[#bc9437]">
                  {activeTable}
                </p>
              </div>
            </div>
            ...
            {[...Array(9)].map((_, i) => {
              ...
              const isBooked =
                selectedDateForBooking && bookedSeats.includes(seatId);
              ...
              return (
                ...
                >
                  <span
                    className={`text-sm md:text-2xl font-serif font-black italic
                  ...
                  {isSelected && (
                    <div className="absolute -top-2 -right-2 md:-top-3 md:-right-3 w-4 h-4 md:w-6 md:h-6 bg-[#bc9437] rotate-45 flex items-center justify-center shadow-lg border border-[#1a1a1a] md:border-2">
                      <span className="text-[8px] md:text-[10px] text-[#1a1a1a] -rotate-45 font-black">
                        ✓
                      </span>
                    </div>
                  )}
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-10 bg-white border border-gray-500 p-8 ">
            <h2 className="text- text-gray-800 font-medium uppercase tracking-widest mb-6">
              Reservation Summary
            </h2>
              ...
              {selectedSeats.length === 0 ? (
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedSeats.map((seat) => (
                    <span
                      key={seat}
                      className="bg-gray-100 text-[#1a1a1a] px-3 py-1 text-xs font-bold rounded-full flex items-center"
                    >
                      {seat}
                      <button
            ...
            <div className="border-t pt-6">
              ...
              <button
                ...
                title={
                  !selectedDateForBooking ? "Please select a date first" : ""
                }
              >
                Proceed to Details
              </button>
      ...
      {isDrawerOpen && (
        <div
          className={`fixed top-0 right-0 h-screen w-full sm:w-[500px] bg-white z-100 shadow-[-25px_0_60px_rgba(0,0,0,0.2)] transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] p-12 overflow-y-auto translate-x-0`}
        >
          <button
            onClick={() => setIsDrawerOpen(false)}
            className="text-gray-800 cursor-pointer hover:text-black mb-4 flex font-medium items-center gap-2 text-sm tracking-widest"
          >
            ← BACK TO SELECTION
          </button>

          <h2 className="text-4xl font-serif font-semibold mb-2 italic">
            Guest Information
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="space-y-2">
              <label className="text-[12px] uppercase tracking-[0.2em] text-gray-800">
                Reservation Name
              </label>
              <input
                required
                ...
                className="w-full border-b border-gray-300 py-2 focus:outline-none focus:border-[#c4a661] transition-colors"
            ...
            <div className="grid grid-cols-2 gap-8">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full border-b border-gray-300 py-2 focus:outline-none focus:border-[#c4a661]"
                />
              </div>
              <div className="space-y-2">
                <label className="text-[12px] uppercase tracking-[0.2em] text-gray-800">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full bg-[#FAFAFA] border-none p-4 focus:outline-none focus:ring-1 focus:ring-[#c4a661] text-sm"
                placeholder="Allergies, anniversaries, or special preferences..."
              ></textarea>
            </div>

            <button
              type="submit"
              className="w-full bg-[#1a1a1a] text-[#c4a661] py-5 mt-4 hover:bg-[#c4a661] hover:text-white transition-all duration-500 hover:scale-105 font-bold tracking-[0.3em] uppercase text-xs shadow-xl"
            >
              Confirm Booking
            </button>
          </form>
