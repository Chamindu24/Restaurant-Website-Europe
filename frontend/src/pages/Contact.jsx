...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FDFCFB]  font-serif text-[#1A1A1A]">
      {/* --- HERO SECTION --- */}
      <div className="relative h-[45vh] sm:h-[50vh] md:h-[50vh] lg:h-[60vh] xl:h-[70vh] overflow-hidden flex items-center justify-center md:justify-end px-4 md:px-20">
        {/* Hero Image */}
        <img 
          src="/contactcover.jpg" 
          alt="Contact Us - The Estate Mayfair" 
        ...
        <div className="relative z-10 w-full max-w-3xl bg-white/80 backdrop-blur-xl p-1 border-[0.5px] border-amber-700/20 shadow-sm">
          ...
          <div className="border border-amber-700/40 p-8 md:p-12 flex flex-col items-center text-center">
            ...
            <p className="text-stone-600 font-semibold tracking-wide font-serif italic text-base sm:text-lg md:text-2xl leading-relaxed max-w-4xl mx-auto">
              "Our team is at your disposal to ensure every detail of your visit
              is executed with royal precision."
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[88rem] mx-auto px-6 mt-24 relative z-10 pb-20">
        <div className="grid lg:grid-cols-5  rounded-sm overflow-hidden bg-white">
          ...
          <div className="lg:col-span-2 bg-[#1A1A1A] text-white p-10 md:p-14 flex flex-col justify-between">
            <div>
              <div className="flex items-center space-x-3 mb-8">
                ...
                <span className="text-[#C5A059] uppercase tracking-[0.4em] text-xs font-bold">
                  Contact Details
                </span>
              </div>
              <h2 className="text-4xl font-light mb-12 tracking-tight">
                Visit the Estate
              </h2>
              ...
              <div className="space-y-10">
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    <h3 className="text-[#C5A059] uppercase tracking-widest text-[10px] mb-2 font-sans font-bold">
                      Address
                    </h3>
                    <p className="text-gray-300 font-light leading-relaxed tracking-wide">
                      47 Berkeley Square
                      <br />
                      Mayfair, London W1J 5AU
                      <br />
                      United Kingdom
                    </p>
                  </div>
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 font-light">
                      concierge@theestate-mayfair.co.uk
                    </p>
                  </div>
                </div>
          ...
          <div className="lg:col-span-3 bg-white p-10 md:p-14">
            ...
            <p className="text-gray-800 font-sans text-sm tracking-widest uppercase mb-10">
            ...
            {submitted && (
              <div className="mb-8 bg-[#FDF8EE] border border-[#C5A059]/30 text-[#8D7039] p-6 italic animate-in fade-in zoom-in duration-500">
                <p className="flex items-center">
                  <Diamond className="w-4 h-4 mr-3" /> Your message has been
                  formally received. Our concierge will contact you shortly.
                </p>
              </div>
            )}
            ...
            >
              <div className="group">
                <label className="text-[13px] uppercase tracking-[0.2em] text-gray-800 font-sans group-focus-within:text-[#bb9246] transition-colors">
                  Full Name
                </label>
                <input
                  type="text"
              ...
              <div className="group">
                <label className="text-[10px] uppercase tracking-[0.2em] text-gray-800 font-sans group-focus-within:text-[#bb9246] transition-colors">
                  Email Address
                </label>
                <input
                  type="email"
      ...
      <section className="bg-[#FDF6F0] pt-24 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6 mb-16 text-center">
          <h2 className="md:text-5xl text-4xl font-light tracking-[0.2em] uppercase text-gray-950 mb-6">
          ...
          <p className="text-gray-700 text-lg  max-w-3xl mx-auto font-normal leading-relaxed">
            Our establishment is located on the historic Berkeley Square, a
            beacon of London elegance since the 18th century.
          </p>
        </div>
        ...
        <div className="relative h-[550px] w-full group">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 md:translate-x-0 md:left-20 md:top-20 md:translate-y-0 bg-[#1A1A1A] text-white p-10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-[#C5A059]/20 max-w-sm">
            ...
            <div className="space-y-6 text-sm font-light">
              <div>
                <span className="text-gray-200 block text-[10px] uppercase tracking-widest mb-1">
                  Valet Service
                </span>
                <p>
                  Complimentary valet parking is available daily from 6:00 PM at
                  the main entrance.
                </p>
              </div>
              <div>
                ...
                <p>
                  Green Park Station (Jubilee, Victoria, and Piccadilly Lines)
                  is a 4-minute walk.
                </p>
              </div>
            </div>
